...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ShaderViewController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/rhinoid/ShaderViewController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rhinoid' => 'rhino@finished.nl' }
  s.source           = { :git => 'https://github.com/rhinoid/ShaderViewController.git', :tag => s.version.to_s }
